    ...
    <transition name="normal"
      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="middle"
          ...
          <scroll class="middle-r" ref="lyricList" :dataJson="currentLyric && currentLyric.lines">
  ...
  export default {
    ...
    methods: {
      ...
      resetCurrentIndex(list) {
        let index = list.findIndex((value) => value.id == this.currentSong.id)
        this.setCurrentIndex(index)
      },
      getLyric() {
    ...
    mounted() {
      this.$nextTick(() => {
        window.addEventListener('keypress',(event) => {
          ...
          if(code.indexOf(key) >= 0) this.togglePlaying()
        })
      })
    },
    components: {
